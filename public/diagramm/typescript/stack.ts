...
let minVal = 0,
    maxVal = 99999999,
    index = 0;
declare var stackChartName;
(<any>window).stackChartName = [];
        ...
        public render() {
            ...
            d3.csv("../data/Line_Stack.csv", function (error: any, data: any) {
                ...
                $.each(data,function(i,v){
                    (<any>window).stackChartName.push(v.year);
                });
                ...
                state.selectAll("rect")
                    ...
                    .attr('class',function(d){return 'stack-path stack-'+(<any>d).year})
                    .attr('data-fill',function(d){return color((<any>d).name)})
           ...
           /* var zoom = d3.behavior.zoom()
            ...
            function zoomed() {
                ...
                areaPath.attr("d", svg.x(function(d) { return xz(d.date); }));
            }*/
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    ( <any>window).stack = new Chart.Stack(d3.select('#graph'));
    stack.render();
