...
(function (Chart) {
    var Multiline = (function () {
        ...
        Multiline.prototype.render = function () {
            var margin = { top: 100, right: 50, bottom: 30, left: 50 }, width = 650 - margin.left - margin.right, height = 500 - margin.top - margin.bottom;
            ...
            d3.csv("../data/Line_Stack.csv", function (error, data) {
                ...
                yScale.domain([d3.min(conferences, function (c) {
                        return d3.min(c.values, function (v) {
                            return v.papernumber;
                        });
                    }),
                    d3.max(conferences, function (c) {
